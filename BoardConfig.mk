...
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/power-exynos.xml
...
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/sec_c2_manifest_default0_1_0.xml
...
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/vendor.samsung_slsi.hardware.eden_runtime@1.0-service.xml
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/wsm_manifest.xml
DEVICE_MATRIX_FILE := $(DEVICE_PATH)/compatibility_matrix.xml
DEVICE_FRAMEWORK_COMPATIBILITY_MATRIX_FILE := $(DEVICE_PATH)/framework_compatibility_matrix.xml

-include vendor/samsung/a33x/BoardConfigVendor.mk