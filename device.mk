...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/vendor.samsung_slsi.hardware.audio_dump@1.0-service.rc:$(TARGET_COPY_OUT_VENDOR)/etc/vendor.samsung_slsi.hardware.audio_dump@1.0-service.rc \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/wifi/mx140_t_common.hcf:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/mx140_t_common.hcf \
